...
/***/ function(module, exports, __webpack_require__) {
	...
	var Timer = __webpack_require__(159);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var LeftTime = __webpack_require__(160);
	var deepCopyObj = __webpack_require__(161);
	...
	var Timer = React.createClass({
		...
		render: function render() {
			...
			return React.createElement(
				"div",
				null,
				React.createElement(LeftTime, { time: this.state.time,
					leftTime: this.state.leftTime }),
				React.createElement(
					"div",
					{ className: "input-group--time" },
					React.createElement("input", { className: "input--timer", ref: "hour" }),
					React.createElement(
						"span",
						null,
						":"
					),
					React.createElement("input", { className: "input--timer", ref: "minute" }),
					React.createElement(
						"span",
						null,
						":"
					),
					React.createElement("input", { className: "input--timer", ref: "second" })
				),
				React.createElement(
					"button",
					{ className: timerButtonClassName, type: "button",
...
/***/ function(module, exports, __webpack_require__) {
	...
	var LeftTime = React.createClass({
		displayName: "LeftTime",

		getProgressBarLength: function getProgressBarLength() {
			var time = this.props.time.h * 3600 + this.props.time.m * 60 + this.props.time.s;
			var leftTime = this.props.leftTime.h * 3600 + this.props.leftTime.m * 60 + this.props.leftTime.s;
			return time ? leftTime / time * 100 : 0;
		},
		render: function render() {
			var twolength = function twolength(n) {
				return (n < 10 ? "0" : "") + n;
			};
			return React.createElement(
				"div",
				...
				React.createElement(
					"div",
					{ id: "timer-progressbar" },
					React.createElement("div", { style: { width: this.getProgressBarLength() + "%" } })
				),
				React.createElement(
					"div",
					{ id: "left-time" },
					React.createElement(
						"span",
						{ ref: "hour" },
						twolength(this.props.leftTime.h)
					),
					React.createElement(
						"span",
						null,
					...
					React.createElement(
						"span",
						{ ref: "minute" },
						twolength(this.props.leftTime.m)
					),
					React.createElement(
						"span",
						null,
					...
					React.createElement(
						"span",
						{ ref: "second" },
						twolength(this.props.leftTime.s)
					)
				)
			);
		}
...
/***/ function(module, exports) {
	...
	function deepObjCopy(dupeObj) {
		...
		if ((typeof dupeObj === 'undefined' ? 'undefined' : _typeof(dupeObj)) == 'object') {
			if (typeof dupeObj.length != 'undefined') var retObj = new Array();
			for (var objInd in dupeObj) {
				if (_typeof(dupeObj[objInd]) == 'object') {
